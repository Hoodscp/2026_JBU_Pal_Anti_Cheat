...
public:
	...
	TMulticastInlineDelegate<void(class FName CharacterID, class UWBP_Paldex_List_C* SelfWidget)> OnHovered; // 0x0318(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class FName CharacterID, class UWBP_Paldex_List_C* Widget)> OnClicked; // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
