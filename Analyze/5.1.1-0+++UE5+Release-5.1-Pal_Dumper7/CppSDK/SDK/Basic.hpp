...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08F64810;
	constexpr int32 AppendString      = 0x03189350;
	constexpr int32 GNames            = 0x08E69D78;
	constexpr int32 GWorld            = 0x090D3030;
	constexpr int32 ProcessEvent      = 0x03307830;
